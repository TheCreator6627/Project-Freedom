...
const contracts = {
  F: {
    address: '0xe93BCD441452E75D7ED88174a205a9DcCcCc6FAc36',
    abi: [
  {
    "inputs": [
      {
  ...
  Staking: {
    address: '0x938C0EAD6aEF71Da9827194C81E6EaDE4D12D273',
    abi: [
  {
    "inputs": [
      {
  ...
  RewardManager: {
    address: '0x96Febf5384B0C5c2A6800170865bfdE1864c8F0c',
    abi: [
  {
    "inputs": [
      {
  ...
  Treasury: {
    address: '0xC07a2D56CcD1aaFD23a1611c9a3022E478B6fd0',
    abi: [
  {
    "inputs": [
      {
  ...
  TokenVesting: {
    address: '0x4FA12941f9A8F3C7ca146c8c3903d9eAba770AEc',
    abi: [
  {
    "inputs": [
      {
